  ...
  begin
    ...
    begin
      ...
      begin        
        ...
        case AnsiIndexStr(LRadioButton.Text, ['Masculino', 'Feminino', 'Não binário']) of
          0:
            begin
              sGender := 'M';
            end;
...
begin
  {
    O Sender, nesse caso, é o TImage, parent de TISCard, componente que foi clicado;
  }
