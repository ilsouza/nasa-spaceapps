...
//  AResponse.Body.JSONWriter.WritePropertyName('quiz_name');
  ...
  begin
    AResponse.Body.JSONWriter.WriteStartObject;
      ...
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_description').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_01_desc');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_01_desc').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_02_desc');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_02_desc').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_03_desc');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_03_desc').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_04_desc');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_04_desc').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_ro');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_ro').AsString);

      AResponse.Body.JSONWriter.WritePropertyName('que_link_yt');
      AResponse.Body.JSONWriter.WriteValue(FModule.qryQuizGet.FieldByName('que_link_yt').AsString);
